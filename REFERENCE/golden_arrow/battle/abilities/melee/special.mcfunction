...
execute if entity @s[scores={gdark.global.self_clock=100}] run tag @s add g_arrow:lock_weapon
...
execute if entity @s[scores={gdark.global.self_clock=140}] run tag @s remove g_arrow:lock_weapon