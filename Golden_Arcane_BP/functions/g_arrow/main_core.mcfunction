...
#// execute as @e[type=goldark:golden_arrow] at @s if entity @a[r=24] run function g_arrow/battle/battle_core
...
execute as @a[scores={goldark.curse_level.g_arrow=1..}] at @s unless entity @e[type=goldark:golden_arrow] run function g_arrow/curse/curse_core