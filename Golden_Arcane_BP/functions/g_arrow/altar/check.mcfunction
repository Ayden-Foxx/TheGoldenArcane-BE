...
tag @s[tag=!g_arrow:altar.is_valid, scores={gdark.g_arrow.altar_check=14}] add g_arrow:altar.is_valid
tag @s[tag=g_arrow:altar.is_valid, scores={gdark.g_arrow.altar_check=..13}] remove g_arrow:altar.is_valid