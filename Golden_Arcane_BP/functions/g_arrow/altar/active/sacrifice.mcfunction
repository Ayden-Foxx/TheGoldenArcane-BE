...
execute as @e[r=1.5, c=1, family=mob, family=!ga_boss] unless entity @e[r=8, family=mob, tag=g_arrow:altar.sacrifice] run playsound mob.blaze.breathe @a[r=8] ~ ~ ~ 0.85 0.6
execute as @e[r=1.5, c=1, family=mob, family=!ga_boss] unless entity @e[r=8, family=mob, tag=g_arrow:altar.sacrifice] run particle minecraft:knockback_roar_particle
execute as @e[r=1.5, c=1, family=mob, family=!ga_boss] unless entity @e[r=8, family=mob, tag=g_arrow:altar.sacrifice] run tag @s add g_arrow:altar.sacrifice

execute as @a[r=1, c=1] unless entity @a[r=8, tag=g_arrow:altar.sacrifice] run playsound mob.blaze.breathe @a[r=8] ~ ~ ~ 0.85 0.4
execute as @a[r=1, c=1] unless entity @a[r=8, tag=g_arrow:altar.sacrifice] run particle minecraft:totem_particle
execute as @a[r=1, c=1] unless entity @a[r=8, tag=g_arrow:altar.sacrifice] run tag @s add g_arrow:altar.sacrifice

execute if entity @e[r=1, tag=g_arrow:altar.sacrifice] unless score @s goldark.g_arrow.altar_check matches 1 run scoreboard players set @s goldark.g_arrow.altar_check 1

# Sacrifices are slowed down, weakened, and slowly consumed until their last bit of health.
effect @e[tag=g_arrow:altar.sacrifice, c=1] blindness 2 0 true
effect @e[tag=g_arrow:altar.sacrifice, c=1] slowness 2 5 true
effect @e[tag=g_arrow:altar.sacrifice, c=1] weakness 1 3 false
effect @e[tag=g_arrow:altar.sacrifice, c=1] wither 1 3 false
...
execute as @e[tag=g_arrow:altar.sacrifice] unless entity @e[type=goldark:altar_spot, r=1.5] run playsound random.fizz @a[r=8] ~ ~ ~ 0.8 1.2
