...
execute if entity @s[hasitem={item=gold_block, location=slot.weapon.mainhand}, tag=!g_arrow:player.is_holding.gold] run titleraw @s actionbar {"rawtext": [{"translate": "gdark.g_arrow.dialog.hint_altar.cross"}]}
...
execute if entity @s[hasitem={item=glowstone, location=slot.weapon.mainhand}, tag=!g_arrow:player.is_holding.glowstone] run titleraw @s actionbar {"rawtext": [{"translate": "gdark.g_arrow.dialog.hint_altar.center"}]}
...
execute if entity @s[hasitem={item=redstone, location=slot.weapon.mainhand}, tag=!g_arrow:player.is_holding.redstone] run titleraw @s actionbar {"rawtext": [{"translate": "gdark.g_arrow.dialog.hint_altar.ring"}]}
...
execute if entity @s[hasitem={item=skull, location=slot.weapon.mainhand}, tag=!g_arrow:player.is_holding.skull] run titleraw @s actionbar {"rawtext": [{"translate": "gdark.g_arrow.dialog.hint_altar.focus"}]}
