...
execute positioned as @s unless entity @a[r=8, m=!c] unless entity @s[tag=g_arrow:dashing] run replaceitem entity @s slot.weapon.mainhand 0 bow
execute positioned as @s unless entity @a[r=8, m=!c] unless entity @s[tag=g_arrow:dashing]  run replaceitem entity @s slot.weapon.offhand 0 air

# CLOSE - Spectre Swords, melee damage
execute positioned as @s if entity @a[r=8, m=!c] unless entity @s[tag=g_arrow:dashing] run replaceitem entity @s  slot.weapon.mainhand 0 golden_sword
execute positioned as @s if entity @a[r=8, m=!c] unless entity @s[tag=g_arrow:dashing] run replaceitem entity @s slot.weapon.offhand 0 golden_sword
...
execute as @e[tag=g_arrow:doom_spear, tag=!g_arrow:evoked] at @s if entity @a[r=2.4] run summon evocation_fang ^ ^ ^1
