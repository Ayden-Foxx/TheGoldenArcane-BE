## When an arrow is shot at the Altar's skull, a ritual is triggered to summon Golden Arrow, the frigid warrior of destruction.
...
execute as @e[type=armor_stand, name=galtar_summon] at @s run particle minecraft:endrod ~ ~3.5 ~
