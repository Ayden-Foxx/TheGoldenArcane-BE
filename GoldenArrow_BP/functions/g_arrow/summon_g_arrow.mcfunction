...
replaceitem entity @e[type=stray, tag=G_Arrow] slot.armor.head 0 keep golden_helmet
replaceitem entity @e[type=stray, tag=G_Arrow] slot.armor.chest 0 keep golden_chestplate
replaceitem entity @e[type=stray, tag=G_Arrow] slot.armor.legs 0 keep golden_leggings
replaceitem entity @e[type=stray, tag=G_Arrow] slot.armor.feet 0 keep golden_boots
